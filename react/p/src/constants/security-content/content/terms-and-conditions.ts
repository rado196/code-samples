  ...
  blocks: [
    {
      ...
      content: [
        `
          By accessing and placing an order with 443, you confirm that you are
        ...
        `,
        `
          Under no circumstances shall 443 team be liable for any direct,
          ...
          inability to use, the materials on this site, even if 443 team or an
        ...
        `,
        `
          443 will not be responsible for any outcome that may occur during the
...

    {
      ...
      content: [
        `
          443 grants you a revocable, non-exclusive, non-transferable, limited
          license to download, install and use the app strictly in accordance
          with the terms of this Agreement.
        `,
        `
          These Terms & Conditions are a contract between you and 443 (referred
          to in these Terms & Conditions as “443”, “us”, “we” or “our”), the
          provider of the 443 website and the services accessible from the 443
          website (which are collectively referred to in these Terms &
          Conditions as the “443 Service”).
        `,
        `
          You are agreeing to be bound by these Terms & Conditions. If you do
          not agree to these Terms & Conditions, please do not use the 443
      ...
      content: [
        ...
        [
          ...
          `
            ...
            it refers to 443, that is responsible for your information under
            this Terms & Conditions.
          `,
          `
            Country: where 443 or the owners/founders of 443 are based, in this
            case is Armenia
          `,
          `
            Device: any internet connected device such as a phone, tablet,
            computer or any other device that can be used to visit 443 and use
            the services.
          `,
          `
            Service: refers to the service provided by 443 as described in the
          ...
          `,
          `
            Website: “443’s” site, which can be accessed via this URL:
          `,
          `
            You: a person or entity that is registered with 443 to use the
            Services.
          `,
        ],
      ],
      ...
      content: [
        ...
        [
          ...
          `
            ...
            notice of copyright or trademark) of 443 or its affiliates,
...

    {
      ...
      content: [
        `
          Thanks for shopping at 443. We appreciate the fact that you like to
        ...
        `
          ...
          apply to transactions at 443. We’ll be as brief as our attorneys will
          allow. The main thing to remember is that by placing an order or
          making a purchase at 443, you agree to the terms along with “443.’s”
          Privacy Policy.
        `,
        `
...

    {
      ...
      content: [
        `
          ...
          (collectively, “Suggestions”) provided by you to 443 with respect to
          the app shall remain the sole and exclusive property of 443.
        `,
        `
          443 shall be free to use, copy, modify, publish, or redistribute the
...

    {
      ...
      content: [
        `
          ...
          contain links to other websites not operated or controlled by 443. We
...

    {
      ...
      content: [
        `
          443 uses “Cookies” to identify the areas of our website that you have
...

    {
      ...
      content: [
        `
          You acknowledge and agree that 443 may stop (permanently or
          temporarily) providing the Service (or any features within the
          Service) to you or to users generally at 443’s sole discretion,
          without prior notice to you. You may stop using the Service at any
          time. You do not need to specifically inform 443 when you stop using
          the Service. You acknowledge and agree that if 443 disables access to
...

    {
      ...
      content: [
        `
          443 reserves the right to modify, suspend or discontinue, temporarily
...

    {
      ...
      content: [
        `
          443 may from time to time provide enhancements or improvements to the
        ...
        `
          ...
          of the app. You agree that 443 has no obligation to (i) provide any
...

    {
      ...
      content: [
        ...
        `,
        `
          You acknowledge and agree that 443 shall not be responsible for any
          ...
          or any other aspect thereof. 443 does not assume and shall not have
...

    {
      ...
      content: [
        `
          This Agreement shall remain in effect until terminated by you or 443.
        `,
        `
          443 may, in its sole discretion, at any time and for any or no reason,
        ...
        `
          ...
          443, in the event that you fail to comply with any provision of this
        ...
        `,
        `
          Termination of this Agreement will not limit any of 443’s rights or
...

    {
      ...
      content: [
        `
          You agree to indemnify and hold 443 and its parents, subsidiaries,
...

    {
      ...
      content: [
        `
          ...
          permitted under applicable law, 443, on its own behalf and on behalf
          ...
          Without limitation to the foregoing, 443 provides no warranty or
        ...
        `,
        `
          Without limiting the foregoing, neither 443 nor any 443’s provider
          ...
          content, or e-mails sent from or on behalf of 443 are free of viruses,
...

    {
      ...
      content: [
        `
          ...
          of 443 and any of its suppliers under any provision of this Agreement
        ...
        `
          ...
          443 or its suppliers be liable for any special, incidental, indirect,
          ...
          Agreement), even if 443 or any supplier has been advised of the
...

    {
      ...
      content: [
        ...
        `
          ...
          notices published by 443 on the Services, shall constitute the entire
          agreement between you and 443 concerning the Services. If any
          ...
          or any other term, and “443’s” failure to assert any right or
          provision under this Agreement shall not constitute a waiver of such
          right or provision. YOU AND 443 AGREE THAT ANY CAUSE OF ACTION ARISING
...

    {
      ...
      content: [
        `
          443 reserves the right, at its sole discretion, to modify or replace
        ...
        `
          ...
          agree to the new terms, you are no longer authorized to use 443.
        `,
      ],
    },

    {
      ...
      content: [
        `
          The Agreement constitutes the entire agreement between you and 443
          regarding your use of the app and supersedes all prior and
          contemporaneous written or oral agreements between you and 443.
        `,
        `
          You may be subject to additional terms and conditions that apply when
          you use or purchase other 443’s services, which 443 will provide to
...

    {
      ...
      content: [
        `
          ...
          are owned by 443, its licensors or other providers of such material
          and are protected by Armenia and international copyright, trademark,
          ...
          express prior written permission of 443, unless and except as is
          expressly provided in these Terms & Conditions. Any unauthorized use
...

    {
      ...
      content: [
        `
          ...
          REGARDING THE ENFORCEMENT OR VALIDITY OF YOUR OR “443’s” INTELLECTUAL
          PROPERTY RIGHTS. The term “dispute” means any dispute, action, or
          other controversy between you and 443 concerning the Services or this
...

    {
      ...
      content: [
        `
          In the event of a dispute, you or 443 must give the other a Notice of
          ...
          any Notice of Dispute via email to: football@443.how. 443 will send
          any Notice of Dispute to you by mail to your address if we have it, or
          otherwise to your email address. You and 443 will attempt to resolve
          any dispute through informal negotiation within sixty (60) days from
          the date the Notice of Dispute is sent. After sixty (60) days, you or
          443 may commence arbitration.
        `,
      ],
    },

    {
      ...
      content: [
        `
          If you and 443 don’t resolve any dispute by informal negotiation, any
...

    {
      ...
      content: [
        `
          ...
          and will become the sole property of 443 without any compensation or
          credit to you whatsoever. 443 and its affiliates shall have no
...

    {
      ...
      content: [
        `
          443 may, from time to time, include contests, promotions, sweepstakes,
          or other activities (“Promotions”) that require you to submit material
          or information concerning yourself. Please note that all Promotions
          may be governed by separate rules that may contain certain eligibility
...

    {
      ...
      content: [
        `
          ...
          representative of 443. 443 will be entitled to injunctive or other
          equitable relief (without the obligations of posting any bond or
          surety) in the event of any breach or anticipatory breach by you. 443
          operates and controls the 443 Service from its offices in Armenia. The
          ...
          choose to access the 443 Service from other locations do so on their
          ...
          Conditions (which include and incorporate the 443 Privacy Policy)
          contains the entire understanding, and supersedes all prior
          understandings, between you and 443 concerning its subject matter, and
...

    {
      ...
      content: [
        `
          443 is not responsible for any content, code or any other imprecision.
        `,
        `
          443 does not provide warranties or guarantees.
        `,
        `
          In no event shall 443 be liable for any special, direct, indirect,
        ...
        `,
        `
          The 443 Service and its contents are provided “as is” and “as
          available” without any warranty or representations of any kind,
          whether express or implied. 443 is a distributor and not a publisher
          of the content supplied by third parties; as such, 443 exercises no
          ...
          accessible via the 443 Service. Without limiting the foregoing, 443
          specifically disclaims all warranties and representations in any
          content transmitted on or in connection with the 443 Service or on
          sites that may appear as links on the 443 Service, or in the products
          provided as a part of, or otherwise in connection with, the 443
          ...
          443 or any of its affiliates, employees, officers, directors, agents,
          ...
          443 does not warrant that the 443 Service will be uninterrupted,
